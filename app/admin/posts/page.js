    ...
    <div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm mb-8 border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold text-gray-600 mb-1">Tiêu Đề Bài Viết (*)</label>
            <input
              type="text"
              required
              ...
              onChange={(e) => {
                ...
                // Nếu đang tạo mới (chưa có id), tự động sinh slug từ tiêu đề
                setFormData({
                  ...formData,
                  title: titleVal,
          ...
          <div>
            <label className="block text-xs font-bold text-gray-600 mb-1">Slug (Đường dẫn URL SEO)</label>
            <input
              type="text"
              required
              className="w-full p-2.5 border rounded-xl text-sm bg-gray-50 font-mono text-xs"
          ...
          <div>
            <label className="block text-xs font-bold text-gray-600 mb-1">Hình Ảnh Bài Viết</label>
          ...
          <div>
            <label className="block text-xs font-bold text-gray-600 mb-1">Tóm Tắt Bài Viết</label>
            <textarea
              rows={2}
              className="w-full p-2.5 border rounded-xl text-sm"
          ...
          <div>
            <label className="block text-xs font-bold text-gray-600 mb-1">Nội Dung Bài Viết</label>
            <textarea
              rows={6}
              required
              className="w-full p-2.5 border rounded-xl text-sm"
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="published" className="text-xs font-bold text-gray-700">Cho phép hiển thị lên website</label>
          </div>

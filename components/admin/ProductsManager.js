...
// khai báo" và bỏ được màn hình chờ ban đầu.
export default function ProductsManager({ initialProducts = [], initialCategories = [], userPermissions = [] }) {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="bg-gray-100 text-gray-700 border px-3 py-2 rounded-xl text-sm font-bold hover:bg-gray-200"
            >
              📥 Tải File Mẫu
            </button>
            <button
              onClick={handleExportExcel}
              className="bg-emerald-50 text-emerald-700 border border-emerald-200 px-3 py-2 rounded-xl text-sm font-bold hover:bg-emerald-100"
            >
              📊 Xuất Excel
            </button>
            <label className="bg-blue-600 text-white px-3 py-2 rounded-xl text-sm font-bold cursor-pointer hover:bg-blue-700">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm mb-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold text-gray-600 mb-1">Mã Sản Phẩm (*) (Key chính)</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-sm font-bold text-gray-600 mb-1">Tên Sản Phẩm (*)</label>
                <input
                  type="text"
                  required
            ...
            <div>
              <label className="block text-sm font-bold text-gray-600 mb-1">Đường dẫn thân thiện (Slug URL)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-bold text-gray-600 mb-1">Danh Mục Sản Phẩm (Chọn nhiều)</label>
            ...
            <div>
              <label className="block text-sm font-bold text-gray-600 mb-1">Hình Ảnh Sản Phẩm</label>
                  ...
                  products.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      <td className="p-3 font-mono">
                        ...
                        <div className="text-sm text-blue-600">{item.slug}</div>
                      </td>
                      <td className="p-3">
                        {item.image ? (

      ...
      <div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm mb-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-bold text-gray-600 mb-1">Tiêu Đề Tin Tức (*)</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-sm font-bold text-gray-600 mb-1">Hình Ảnh Tin Tức</label>
            ...
            <div>
              <label className="block text-sm font-bold text-gray-600 mb-1">Tóm Tắt Nhanh (Summary)</label>
              <textarea
                rows={2}
                className="w-full p-2.5 border rounded-xl text-sm"
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="published_news" className="text-sm font-bold text-gray-700 cursor-pointer">Cho phép hiển thị tin tức</label>
            </div>

...
export default function CategoriesManager({ initialCategories = [], userPermissions = [] }) {
      ...
      <div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm mb-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-bold text-gray-600 mb-1">Mô Tả Danh Mục</label>
              <textarea
                rows={3}
                className="w-full p-2.5 border rounded-xl text-sm"
